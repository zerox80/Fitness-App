...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: Colors.card, borderRadius: 18, paddingHorizontal: 20, paddingVertical: 16, color: Colors.text, fontSize: 16, borderWidth: 1, borderColor: Colors.glassBorder, fontWeight: '600' },
